    ...
    <div className="w-full ">
      ...
      <div className="pt-10 px-5 md:w-[85%] mx-auto">
        ...
        <div className="">
          ...
          speech means speech. আমরা জানি speech বা বক্তব্য হয় Sentence বা
          বাক্যের মাধ্যমে। আবার Sentence গঠিত হয় Word এর সাহায্যে। We know that
          speech is through sentences or sentences. <br /> Sentences are formed
          ...
          1. Concrete Noun : যার বাহ্যিক অস্তিত্ব এবং শারীরিক গঠন আছে। Concrete
          Noun: Which has external existence and physical structure.
          <br />
          যেমন : Table, Chair, Rahim, Karim, Dhaka, London ইত্যাদি...
          <br />
          2. Abstract Noun : এটা মূলত ব্যাক্তি বা বস্তুর অবস্থা, গুণ, প্রকৃতি
          সম্পর্কিত নামগুলো বুঝায়। এদের বাহ্যিক অস্তিত্ব নেই। Abstract Noun: It
          ...
          যেমন : Boy - Boys, Mango - Mangos For example: boy - age, mango -
          mangos <br />
          Uncountable Noun : যে Noun গণনা করা যায় না। Uncountable Noun: Noun
          that cannot be counted. <br />
          1. always Singular. 2. এদের সাথে s/es বসে না। 2(S/Es does not sit with
          them. )<br />
          যেমন : Fun, News, Information, Wind etc. . <br />
          <br />
          Pronoun: Pro শব্দের অর্থ পরিবর্তে আর Noun শব্দের অর্থ নাম। The word
          pro means instead and the word noun means name. অর্থাৎ, Noun/নামের
          পরিবর্তে যে Word ব্যবহার করা হয় সেটাই Pronoun. That is, the word used
          ...
          verb. <br />
          যেমন : Sing, Love, Think, Laugh, Cry, Jump etc. <br />
          Verb দুই প্রকার: <br />
          ...
          5. to যুক্ত Modals : ought to, have to, be to, used to, be going to,
          be about to..
          <br />
          <br />
          Non-Finite Verb: <br />
          ...
          <br />
          Technique : Gerund দ্বারা স্থির অবস্থা বোঝায়। Technique: Gerund
          refers to the state of station.
          <br />
          <br />
          Participle: <br />
          ...
          <br />
          Adverb <br />
          Adverb: যে সকল Word Noun/Pronoun ছাড়া Adjective, Verb বা কোনো Adverb
          ...
          <br />
          Adverbs can also be found by asking questions by how, when, where,
          why.
          <br />
          <br />
          Preposition
