          ...
          <div className="p-3 text-black md:p-16 bg-[#EFE5D6] book-shadow">
            ...
            <div className="">
              <p className="text-xs md:text-base">
                ...
                জন্য আমাদের বই <br />
                আমরা বাংলাদেশীরা স্কুল/কলেজ/ভার্সিটিতে যেভাবে ইংরেজি উচ্চারণ
                শিখে এসেছি সেভাবেই উচ্চারণ করতে অভ্যস্ত, যা বিদেশী বা ন্যাটিভদের
                সাথে অনেকাংশে মিল হয় না। কিন্তু, গ্লোবালাইজেশনের এ যুগে বিভিন্ন
                ...
                মাঝামাঝি একটি উচ্চারণ যেটি বাংলায় কোন বর্ণ নেই। এজন্য, মূলতঃ
                বইটিতে উল্লেখিত উদাহরণ বার বার প্র্যাকটিসের মাধ্যমে শুদ্ধ
                উচ্চারণ আয়ত্ত্ব করতে হবে। <br />
          ...
          <div className="p-3 text-black md:p-16 bg-[#EFE5D6] book-shadow">
            ...
            <div className="">
              ...
              <div className="w-full flex  justify-between text-sm md:text-base">
                ...
                <p className="">
                  R = আ (র) <br />S = এস্ <br />T = ঠী <br />U = ইউ <br />V =
                  ভীই <br />W = ডাবল্টউ <br />X = এক্স <br />Y = ওয়াই <br />Z =
                  জেড/জি <br />
            ...
            <div className="">
              ...
              <div className="text-sm md:text-base">
                <p className="">
                  ...
                  ✨ The এর পর যদি Consonant sound থাকে তবে এর উচ্চারণ 'দা' এর
                  মতো হবে। <br />
                  যেমন: <br />
                  The ball = দা বল <br />
            ...
            <div className="">
              ...
              <div className="text-sm md:text-base">
                <p className="">
                  ...
                  এগুলো উচ্চারণের সময় মুখ দিয়ে বেশি পরিমানে বাতাস বের হবে।{" "}
                  <br />
          ...
          <div className="p-3 text-black md:p-16 bg-[#EFE5D6] book-shadow">
            ...
            <div className="">
              ...
              <p className="pt-2">
                ...
                প্র্যাকটিস করতে হবে। অনলাইন ডিকশনারীঃ
          ...
          <div className="p-3 text-black md:p-16 bg-[#EFE5D6] book-shadow">
            ...
            <div className="">
              ...
              <div className=" text-sm md:text-base">
                ...
                না। অর্থাৎ সেই অক্ষরগুলোর উচ্চারণ 'প', 'ট', 'ক' এর মত হয়।
                'ফ','ঠ', 'খ' এর মত নয়। যেমনঃ <br />
              ...
              Backupব্যাকআপ <br /> */}
                ...
                'Word' এর মাঝখানে যখন 'p, t, k' থাকে সেই Sound- কখনও Aspirated
                হয়, আবার কখনও Aspirated হয় না। যদি মাঝের অক্ষরটির 'p/t/k' উপর
                stress দেয়া হয়, তাহলে Sound-টি Aspirated হবে; আর যদি stress দেয়া
                না হয়, তাহলে Sound-টি Aspirated হবে না। যেমনঃ <br />
          ...
          <div className="p-3 text-black md:p-16 bg-[#EFE5D6] book-shadow">
            ...
            <div className="">
              ...
              <div className=" text-sm md:text-base">
                ...
                অভ্যস্ত। <br />
                আমরা বাংলাদেশিরা আবার আমেরিকানদের মতো 'Accent' অর্থাৎ বাচনভঙ্গি
                না করতে পারলেও প্রায় সবখানেই 'R' এর উচ্চারণ করে থাকি। তবে,
                ইংরেজি বলার সময় আমাদের ব্রিটিশ ও আমেরিকান: এই দুই ধরনের
                উচ্চারণের মিশ্রণ সমীচীন নয়। কাজেই, চলুন জেনে নিই ব্রিটিশরা কোথায়
                'R' এর উচ্চারণ করে; আর কোথায় করে না।
                <br />
                <br />
          ...
          <div className="p-3 text-black md:p-16 bg-[#EFE5D6] book-shadow">
            ...
            <div className="">
              ...
              <div className=" text-sm md:text-base">
                ...
                ইংরেজিতে মোট ৪৪টি সাউন্ড রয়েছে। বিদেশীরা যেভাবে শুদ্ধ উচ্চারণে
                কথা বলে এর মূল ভিত্তি মূলতঃ ৪৪টি সাউন্ড। এই ৪৪টি সাউন্ড সঠিকভাবে
                ...
                বিভিন্ন উদাহরণের মাধ্যমে শেখানোর চেষ্টা করবো। <br />
                প্রথমেই আমি 24 consonant sound এর বিস্তারিত আলোচনা করবো। Let's
                get started. <br />
              </div>
            </div>
          </div>
