    ...
    <div className="mx-3 md:w-[85%] md:mx-auto bg-gray-100 text-gray-800 shadow-md mb-6 rounded-sm">
      <div className="py-20">
        ...
        <div>
          ...
          <h3>1. ** Your Aim in Life**</h3>
          <h3>2. ** Your Future Plan of Life**</h3>
          <h3>3. ** If you were a Politician/ Teacher/ Doctor**</h3>
          <h3>4. ** Why you want to be a ........**</h3>
        ...
        <div>
          ...
          <h3>Or, Visit to a village.</h3>
          <h3>Or, Importance of travelling/journey.</h3>
          <h3>Or, Journey by boat/train/bus that you have made recently.</h3>
          <h3>Or, a study tour/excursion that you enjoyed.</h3>
