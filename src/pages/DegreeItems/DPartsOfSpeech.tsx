  ...
  return (
    <div className="px-5 md:w-[85%] mx-auto">
      ...
      <div className="my-10">
        ...
        শব্দের শেষে - ous, Full, ive, le, el, able, ible, il, al, cal, ile, ent,
        ant, ain, ane, ure, ic, ish ty, ry, sy, wy, py, ky, dy থাকলে Adjective
        হয় । <br />
        Example:
        <br />
        ...
        শব্দের শেষে - Hood, Our, er, or, tion, sion, Ment, ship, nce, ance, ty,
        th, ht, ness, ist, val ism, asm থাকলে Noun হয়।
        <br />
        Example:
        <br />
        ...
        শব্দের শেষে - ine, ise, ize, de থাকলে, শব্দের শুরুতে - em থাকলে , শব্দের
        শুরুতে/ শেষে - en থাকলে, শুরুতে - be থাকলে , শেষে - ume, ute, atc থাকলে
        , শেষে - ss, fy থাকলে Verbহয়। Example -<br />
        Examine, realise, embed, tighten, enlarge, beware, contribute, educate,
        consume, possess, beautify,
        <br />
        <br />
        ...
        <br />
        <br />
        বিঃ দ্রঃ সুতরাং Parts of Speech চিনিবার প্রধান উপায় হল "সজ্ঞা" জানা এবং
        প্রদত্ত শব্দটির অর্থ জানা।
        <br />
        <br />
        ...
        <br />
        (1) Adjective এর শেষে ent/ant-থাকলে "t"- এর পরিবর্তে ce/cy যোগ করতে হয়।{" "}
        <br />
        যেমনঃ - <br />
        Absent - Absence
        <br />
