const Rearrange = () => {
  return (
    <div className="w-[95%] md:w-[70%] mx-auto ">
      ...
      <div className="py-10">
        word order of sentences exercises honours 2nd year : জাতীয়
        বিশ্ববিদ্যালয়ের অনার্স ২য় বর্ষের নন-মেজর ইংরেজির গুরুত্বপূর্ণ একটি টপিক
        হচ্ছে- Word Order of Sentence রাইটিং। এ টপিকে মূলত কয়েকটি বাক্য দেওয়া
        থাকে, আর বাক্যের মধ্যকার শব্দগুলো থাকে এলোমেলো। শিক্ষার্থীদের কাজ
        হচ্ছে, এই শব্দগুলো যথাযথ সাজিয়ে বাক্যটিকে একটি অর্থবোধক রূপ দেওয়া।{" "}
        <br /> <br />
