const QuestionSix = () => {
  return (
    <div className="h-full lg:w-1/2 px-4 text-sm md:text-base">
      ...
      <div className="text-justify pb-10">
        ...
        (a) palace, Saadi deliberately stopped at the same courtier's house. On
        his way back home from the emperor's <br />
        (c) During the meal, however, the guest began to put the delicacies into
        the folds of his fine clothes. <br />
        ...
        were extremely hospitable, offering him a spread of fine dishes. <br />
        (g) Surprised, the courtier asked, "Why are you feeding your clothes, my
        honorable guest?" <br />
        ...
        (j) So, he treated the great man with indifference, offering him only a
        small meal and poor accommodation. <br />
        <br />
        ...
        প্রাপ্য। <br />
        (f) অতিথির মূল্যবান পোশাক দেখে, সভাসদ এবং তার লোকজন খুবই বিভিন্ন প্রকার
        চমৎকার খাবার দিয়ে তাকে চরম আতিথ্য দেখালো। <br />
        ...
        (c) Abu then requested him to put his name in the list because he loved
        mankind and his fellow brothers. <br />
        (d) He again appeared the next night and showed Abu that his name was at
        ...
        (vi) কিন্তু মাত্র একজন ব্যক্তি ছিলেন যিনি ছেলেটির ওপর কখনোই বিরক্ত হতেন
        না। <br />
        ...
        (iii) On the way, he took shelter in a courtier's house but the courtier
        and his men did not show much honour and hospitality to him. <br />
        ...
        (vii) The courtier received him cordially and entertained him with rich
        and delicious foods. <br />
        ...
        (b) Then one day the fruit seller said to the grocer, "I am going to the
        town to do some shopping. Please send your son with me to carry my
        things." <br />
        (c) The grocer said. "The mice ate away your balance and weights. So, I
        can't return it to you." <br />
        ...
        <br />
        (f) The grocer sent his son with the fruit seller but he came back alone
        from the town. <br />
        ...
        (vii) So, the owner of the house lodged a complaint in the court. <br />
        (viii) The Judge found one of the sticks shorter than the others and in
        this way he could easily catch the thief. <br />
        (ix) Naturally, it was suspected that one of the servants had stolen the
        necklace. <br />
        ...
        (iv) চাকরদেরকে আদালতে হাজির হওয়ার জন্য আদেশ জারি করা হলো কিন্তু তারা হার
        চুরির বিষয়টি অস্বীকার করলো। <br />
        ...
        (viii) বিচারক দেখলেন যে একটি লাঠি অনাগুলোর চেয়ে ছোট এবং এভাবে তিনি সহজেই
        চোরকে ধরতে পারলেন। <br />
        (ix) স্বাভাবিকভাবেই সন্দেহ করা হলো যে চাকরদের মধ্যেই কেউ একজন হারটি চুরি
        করেছে। <br />
        ...
        <br />
        (iii) He then looked all the attendees to the room and asked each one to
        randomly collect a balloon and give it to the person whose name was
        written on it. <br />
        ...
        (ii) প্রত্যেককেই বলা হয়েছিল মার্কার কলম দিয়ে বেলুনে নাম লিখে ছেড়ে দিতে।{" "}
        <br />
        (iii) এরপর তিনি অংশগ্রহণকারীদের কক্ষটিতে নিয়ে প্রত্যেককে বললেন ইচ্ছামতো
        একটি বেলুন সংগ্রহ করে সেটিতে যার নাম লেখা তাকে দিতে। <br />
        ...
        (d) The man said, "Str. I am very poor. So, I have no food in my house."{" "}
        <br />
        ...
        (i) He helped the poor and helpless people with food and clothes. <br />
        ...
        (f) The great personality is a person who contributed for his country or
        the people. <br />
        ...
        <br />
        (b) জয়নুল আবেদিন ছিলেন এমন একজন ব্যক্তিত্ব যিনি আমাদের সংস্কৃতিকে সমৃদ্ধ
        করেছিলেন। <br />
        ...
        future world. <br />
        (b) The sooner we can make and activate this plan, the better it will be
        for us. <br />
        ...
        robots. <br />
        (f)But we can no longer wait: an exact and realistic plan should be made
        now. <br />
        ...
        (j) This revolution will turn the world into a machine based one. <br />
        <br />
        ...
        ( <br /> d) অতএব, প্রযুক্তি শেখা এবং প্রযুক্তিগত দক্ষতা অর্জনকে গুরুত্ব
        সহকারে ভাবতে হবে। <br />
        (e) মেশিনগুলোর মধ্যে প্রধানত কম্পিউটার, মোবাইল ফোনা এবং রোবট
        অন্তর্ভুক্ত। <br />
        (f) কিন্তু আমরা আর অপেক্ষা করতে পারি না; সঠিক বাস্তবসম্মত পরিকল্পনা এখনই
        করা উচিত। <br />
        ...
        <br />
        (c) মনিবও খুব চালাক ছিলেন এবং এতো সহজে বোকা বনার পাত্র ছিলেন না। <br />
        ...
        pebbles nearby. <br />
        (d) There was some water in the jar, but it was at the bottom and out of
        reach. <br />
        ...
        have a drink. <br />
        (i) When the water came to the mouth of the Jar, the crow drank and met
        up his thirst. <br />
