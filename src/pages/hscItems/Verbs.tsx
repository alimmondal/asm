...
function Verbs() {
  return (
    <div className="h-full ">
      ...
      <div className="h-full w-[95%] md:w-[85%] mx-auto">
        <div className="">
          ...
          <div className="">
            <div>
              ...
              <p className="">
                * S + have/ has + V<sub>3</sub> + obj + extension.
              </p>
          ...
          <div className="">
            ...
            <div className="pb-3">
              ...
              <p>
                (e)
                <span className="bengali">
                  having এবং get, got, gotten এবং Linking-verb (be, become) এর
                  পর ব্রাকেটে Verb থাকলে বাক্যটি V<sub>3</sub> হয়। যেমনঃ
                </span>
                <br />
                Q. The festival (hold). <br />= The festival was held.
              </p>
            ...
            <div className="pb-3">
              <p>
                6. Can, could, may, might, shall, should, will, would, must,
                need, dare, had better, would rather, would better
                <span className="bengali">
            ...
            <div className="pb-3">
              ...
              <p>
                (b)
                <span className="bengali">
                  কিন্তু Be used to, with a view to, look forward to, get used
                  to, addicted to, devoted to, with an eye to, be accustomed to,
                  be opposed to, worth, cannot help, could not help, confess to
                  ইত্যাদির পরে ব্রাকেটের Verb এর সাথে ing হয়। যেমন:
                </span>
              </p>
              <p className="example">
                Q. She is used to (read) Quran. <br />= She is devoted to
                reading Quran.
              </p>
            ...
            <div className="pb-3">
              <p>
                Rule: 8. কিন্তু অনান্য সকল preposition (যেমনঃ in, on, over,
                upon, into, of, by, with, without, before, after, away) এর পরের
                ব্রাকেটের verb এর সাথে ing হয়। যেমন:
              </p>
              <p className="example">
            ...
            <div className="pb-3">
              <p>
                9. (a) Stop, mind, finish, miss, risk, answer, continue, admit,
                deny, avoid, enjoy, fancy, imagine, delay, suggest, postpone,
                involve, practice
                <span className="bengali">
                  ইত্যাদি verb গুলোর পরে ব্রাকেটের verb এর সাথে ing হয়। কিন্তু
                  সাধারণত এই Verb গুলো ছাড়া অন্য কোন Verb এর পরে ব্রাকেটের verb
                  এর V1 হয়।
                </span>
              </p>
              <p className="example">
            ...
            <div className="pb-3">
              <p>
                Rule: 10. (a)প্রথম বক্যে Fancy, wish, it is time, it is high
                time
                <span className="bengali">
              ...
              <p>
                (b)কিন্তু প্রথম বক্যে Fancy, wish, it is time, it is high time,
                as if, as though, if
                <span className="bengali">
            ...
            <div className="pb-3">
              <p>
                <span className="animateText font-bold">Rule: 12. </span> (a) If
                দ্বারা শুরু বাক্যটি
                <span className="bengali">
              ...
              <p>
                ...
                <span className="bengali">
                  ...
                  could have/ might have হবে এবং verb এর V<sub>3</sub> হয়। যেমন:
                </span>
                <br />
              ...
              <p>
                ...
                <span className="bengali">
                  ...
                  would have/ could have/ might have হবে এবং verb এর V
                  <sub>3</sub> হয়। যেমন:
                </span>
              </p>
              <p className="example">
            ...
            <div className="pb-3">
              <p>
                <span className="animateText font-bold">Rule: 14. </span>
                <span className="bengali">
            ...
            <div className="pb-3">
              <p>
                ...
                <span className="bengali">
                  ...
                  While + (V) থাকলে ব্রাকেটের Verb এর সঙ্গে ing যুক্ত হয়। যেমন:
                </span>
              </p>
              <p className="example">
          ...
          <div className="mt-5">
            ...
            <div className="pb-3">
              <p className="bengali">
                23. দৈঘ বা পরিমাণ বাচক শব্দ Sub হেল সেই Sub এর পরে verb singular
                হয়। যেমন:
              </p>
              <p className="example">
