  ...
  return (
    <div className="h-full md:w-[85%] mx-auto px-5">
      ...
      <div className="">
        ...
        <p>= He tells the matter as though he were mad.</p>
        <p>Q. He told the matter as though..........</p>
        <p>= He told the matter as though he had been mad.</p>
        ...
        <p>= Hardly had........ when he came.</p>

        <h3>12. until / till:</h3>
        <p>Q. He will stay here until/ till...........</p>
        <p>= He will stay here until he comes back.</p>
        <h3>13. Unless:</h3>
        ...
        <p>
          = he could not go to college because of poverty/ illness/ shortage of
          mony.
        </p>
        ...
        <p>
          = They do not eat right food because they do not understand / it is
          helpful.
        </p>
        ...
        <p>Q. Would you mind opening the door?</p>
      ...
      <div className="pb-10">
        ...
        <p>47. They replied/ said/ think/ hope that........</p>
        ...
        <p>112. We shall start our journey tomorrow provided......</p>
        <p>113. Since body and mind go together......</p>
        <p>114. Since there was drought......</p>
        <p>115. Wait here until/as long as......</p>
        ...
        <p>167. Neither will she dance nor......</p>
        <p>168. Friendship is easy but......</p>
        <p>169. There are many other creations but......</p>
