    ...
    <div className="px-3">
      ...
      <div className="text-sm lg:text-xl">
        ...
        <div className="">
          ...
          কন্যাসন্তানকে পড়ানো সময় এবং অর্থের অপচয়। তারা সিদ্ধান্ত নেয় যে তারা
          এখন তার বিয়ে দিয়ে দেবে এবং তাদের মূল্যবান/অপ্রতুল সম্পদ পুত্রসন্তানের
          শিক্ষায় ব্যয় করবে। রোকেয়া পড়া এবং পরীক্ষা নিয়ে চিন্তা করতো কিন্তু এখন
          সে বিয়ে এবং সন্তান সন্ততি নিয়ে বেশি ভাবে। সে শিক্ষক হবার স্বপ্ন দেখতো
          কিন্তু এখন গৃহস্থালি কাজকর্ম এবং সন্তান লালন-পালনের জীবনের সম্মুখীন।
        ...
        <div className="">
          ...
          <div className="border border-gray-500 p-1 rounded-sm my-2 ">
            developed | ability | spontaneous | fact | acquisition | natural |
          ...
          রয়েছে। প্রথমটি হলো অর্জন যা মানুষ মাতৃভাষায় যেভাবে দক্ষতা বৃদ্ধি করে
        ...
        {/* 3 */}
        <div className="">
          3. Jashore Board-2025; HSC Exam-2018; Dinajpur Board-2016
          <br />
          <div className="border border-gray-500 p-1 rounded-sm my-2 ">
            warming | recklessly | cut | severe | rise | imperative |
          ...
          সম্পদের এক তৃতীয়াংশ হারিয়েছে। বনজ সম্পদ কেটে ফেলা হচ্ছে। তাছাড়া এদেরকে
        ...
        <div className="">
          ...
          বনাঞ্চল, জলাভূমি, সমুদ্র এবং সৈকত আগে যেমন ছিল তার চেয়ে এখন বাজে
          অবস্থায় আছে। বন কেটে ফেলা হচ্ছে। এছাড়াও নির্বিচারে জ্বালিয়ে দেওয়া
        ...
        {/* 5 */}
        <div className="">
          5. Chattogram Board-2025; Dinajpur Board-2019 10 <br />
          <div className="border border-gray-500 p-1 rounded-sm my-2 ">
          ...
          ভারসাম্যের এমন একটা দৃঢ় অবস্থা প্রকাশ করে যে এই জালের একটি অংশে
        ...
        <div className="">
          ...
          <div className="border border-gray-500 p-1 rounded-sm my-2 ">
            ...
            | channels | vary | set | programmes <br />
          </div>
          Television has (a) __ the most common and widespread (b) __ of
          entertainment of the present world. A wide range of programmes of (c)
          __ interest is telecast on numerous (d) __ . Almost every middle class
          and (e) __ — working class families have a television set today.
          Television (f) __ – are not only enjoyable but also highly educative.
          For example, television is used for (g) __ learning. Courses (h) __ by
          the Open University are (i) __ on BTV. Several channels like the
          Discovery and The National Geographic channels telecast highly (j) __
          programmes. <br />
          <br />
          টেলিভিশন বর্তমান বিশ্বের বিনোদনের সবচেয়ে সাধারণ ও ব্যাপক বিস্তৃত উৎস
          হয়ে উঠেছে। বহুবিধ চ্যানেলে বিভিন্ন রকমের প্রচুর সংখ্যক অনুষ্ঠানমালা
          সম্প্রচার করা হয়। প্রায় প্রতিটি মধ্যবিত্ত এমনকি শ্রমজীবী পরিবারেও আজ
          একটি টেলিভিশন সেট/যন্ত্র আছে। অনুষ্ঠানমালা শুধু বিনোদনমূলক নয় বরং
          এগুলো বেশ শিক্ষণীয়ও বটে। উদাহরণস্বরূপ, দূরশিক্ষণে টেলিভিশন ব্যবহৃত হয়।
        ...
        <div className="">
          ...
          <div className="border border-gray-500 p-1 rounded-sm my-2 ">
            gentleperson | accepted | appreciate | are | proper | behave |
          ...
          পরস্পরের সাথে শিষ্ট আচরণ করতে পারি। এই মূলনীতি অনুসরণ না করলে সবাই
        ...
        {/* 8 */}
        <div className="">
          9. Dhaka Board-2024 <br />
          <div className="border border-gray-500 p-1 rounded-sm my-2 ">
            prosper | be | so | help | idealism | hence | immortal | positive |
            country | welfare | materialism | quality
          </div>
          Good citizens are (a) __ people who are possessing the (b) __ attitude
          about their society, community and (c) __ also. They never possess the
          quality of (d) __ deviated from the right path. They are always
          thinking about the (e) __ of their surroundings. They have all the
          good (f) __ that lead them to the path of (g) __ others. That is why
          good citizens are loved by all. They are not thinking of their (h) __
          prosperity. And, (i) __ they dedicate their lives for others which (j)
          __ them.
          <br />
          সুনাগরিক হলো সেইসব ইতিবাচক মানুষজন যারা সমাজ, সম্প্রদায় ও দেশের
          আদর্শবাদী মনোভাবের অধিকারী। তারা কখনই সঠিক পথ থেকে বিচ্যুত হওয়ার
          বৈশিষ্ট্য ধারন করে না। তারা সবসময় তাদের আশেপাশের কল্যাণের কথা চিন্তা
          করে। তাদের মধ্যে সকল ধরনের সদগুণ বিদ্যমান যেটা তাদেরকে অপরকে সাহায্য
        ...
        {/*  10 */}
        <div className="">
          10.Rajsha Board-2024 <br />
          <div className="border border-gray-500 p-1 rounded-sm my-2 ">
            capable | be | syllabus | enlightenment | frustrate | build |
            requirement | certainly | both | achieve | understand | concentrate
          </div>
          Education aims at (a) __ two things: knowledge and skill. The lessons
          in a (b) __ prepare a learner for gaining knowledge of certain
          subjects. When a learner gets a clear (c) __ of a subject or topic, it
          indicates his/her knowledge. Next appears skill that means the (d) __
          of doing something with the use of knowledge. Knowledge provides us
          with (e) __ and skill presents the ability of doing well. (f) __ the
          ...
          সিলেবাসের পাঠসমূহ একজন শিক্ষার্থীকে নির্দিষ্ট কিছু বিষয়ে জ্ঞান অর্জনে
          প্রস্তুত করে। যখন একজন শিক্ষার্থী কোনো বিষয়ে পরিষ্কার ধারণা পায়, তখন
          সেটা তার জ্ঞানকে নির্দেশ করে। তারপর আসে দক্ষতা যেটা জ্ঞানকে ব্যবহার
          করে কোনো কিছু করার ক্ষমতাকে বোঝায়। জ্ঞান আমাদের আলো প্রদান করে এবং
          দক্ষতা আমাদের ভালো থাকার সামর্থ্য পরিবেশন করে। এই দুইটা জিনিসই
          গুরুত্বপূর্ণ। কিন্তু এখানে আরো একটা গুরুত্বপূর্ণ দাবি আছে। শিক্ষার
        ...
        <div className="">
          ...
          The Padma Bridge is no longer a dream now; it is now a (a) __ This
          multipurpose bridge is going to be a (b) __ boon for the south-western
          part of Bangladesh. But decades ago, it was rather an (c) __ dream, a
          daunting challenge to tame the (d) __ Padma Crossing the river has
          always been strenuous and sometimes dangerous (e) __ to unreliable and
          limited ferry connections and long waits for crowded boats and
          launches. The Padma Bridge that (f) __ Dhaka with 21 southern
          districts is a potential catalyst for major economic (g) __ in the
          lives of over 30 million people (h) __ In the region and will give a
          (i) __ to trade and (j) __ activities. <br />
          <br />
          পদ্মা সেতু বর্তমানে স্বপ্ন নয়, এটা এখন বাস্তবতা। এই বহুমুখী সেতু
          বাংলাদেশের দক্ষিণ-পশ্চিম অংশের জন্য বিরাট আশির্বাদ হতে যাচ্ছে। কিন্তু
          কয়েক দশক আগেও প্রমত্তা পদ্মাকে শাসনের অদম্য চ্যালেঞ্জ মোকাবিলা করে এটা
          ছিলো বরং উচ্চাভিলাষী স্বপ্ন। নদীটি পার হওয়া ছিলো সবসময়ই কঠিন আর
          অনির্ভরযোগ্য ও সীমিত ফেরী সংযোগ এবং জনাকীর্ণ নৌকা ও লথ্যের জন্য দীর্ঘ
          প্রতীক্ষার কারণে কখনো কখনো বিপদজনক। দক্ষিণাঞ্চলের ২১টি জেলাকে ঢাকার
        ...
        <div className="">
          ...
          এবং আমাদের জীবনে বৈপ্লবিক পরিবর্তন এনেছে। গাণিতিক হিসাব করতে যে
          যন্ত্রই আমাদের সাহায্য করে তাকে কম্পিউটার বলা যেতে পারে। এই দৃষ্টিকোণ
          থেকে অ্যাবাকাস একটি সাধারণ কম্পিউটার। যাহোক, বর্তমানে কম্পিউটার শব্দটি
        ...
        <div className="">
          ...
          প্রতিশ্রুতি রক্ষা করার বিষয়টা স্মরণ রাখার একটা ব্যাপার সেহেতু কোনো
          প্রতিশ্রুতি দেওয়ার সময় আমাদের উচিত সতর্ক হওয়া। কোনো অনিবার্য বিপদের
          মুখোমুখি হলে মানুষ ভালমন্দ চিন্তা না করেই সেই অবস্থা থেকে পরিত্রাণ
        ...
        {/* 14 */}
        <div className="">
          14. Dinajpur Board-2024; RDA Laboratory School & College, Bogura-2025
          <div className="border border-gray-500 p-1 rounded-sm my-2 ">
            Misuse | family | popular | invent | use | spreads | expand | users
          ...
          করছে। যদিও মার্ক জুকারবার্গ প্রথম ফেসবুক আবিষ্কার করেন, খুব অল্প সময়ের
          মধ্যেই এটি অনেক জনপ্রিয়তা লাভ করে। এখন এটির এক বিলিয়ন সক্রিয়
          ব্যবহারকারী রয়েছে। এটি ভালোবাসা ছড়িয়ে দেয় ও দুঃখকে ভাগ করে নেয়। কিন্তু
          কখনও কখনও এটির অপব্যবহার হয়। শিক্ষার্থীরা ফেসবুক ব্যবহারে অনেক সময়
        ...
        {/* 15 */}
        <div className="">
          15. Mymensingh Board-2024: Jalalabad Cantonment Public School &
          College, Sylhet-2025
          <div className="border border-gray-500 p-1 rounded-sm my-2 ">
        ...
        {/* 16 */}
        <div className="">
          16. Dhaka Board-2023; Govt. Shah Sultan College, Bogura-2024
          <div className="border border-gray-500 p-1 rounded-sm my-2 ">
            Crown | great | vote | prestige | organize | hold | entertain |
            practice | certain | remember | approximate | difference
          </div>
          Football is the most popular and exciting event for all classes of
          people. The World Cup football is the (a) __ earth show in the world.
          It is the most (b) __ international tournament of football. The
          competition takes place once every four years. FIFA World Cup-2022 was
          ...
          সবচেয়ে মর্যাদাপূর্ণ ক্রীড়া প্রতিযোগিতা। প্রতি চার বছরে একবার এ ক্রীড়া
          প্রতিযোগিতা অনুষ্ঠিত হয়। ফিফা বিশ্বকাপ-২০২২ কাতারে ২০ নভেম্বর হতে ১৮
          ডিসেম্বর অনুষ্ঠিত হয়। বিভিন্ন জাতির ৩২টি দল এ ক্রীড়া প্রতিযোগিতায়
          অংশগ্রহণ করে। ক্রীড়া প্রতিযোগিতা পরিচালনায় প্রায় ২২০ বিলিয়ন ডলার ব্যয়
          করা হয়। পাঁচটি শহরের ৮টি মাঠে ৬৪টি ম্যাচ অনুষ্ঠিত হয়। চূড়ান্ত ম্যাচ
          ফ্রান্স ও আর্জেন্টিনার মধ্যে অনুষ্ঠিত হয়। আর্জেন্টিনা বিজয়ীর মুকুট
          পরলো আর অধিনায়ক লিওনেল মেসি নির্বাচিত হলেন প্রতিযোগিতার শ্রেষ্ঠ
        ...
        {/* 17 */}
        <div className="">
          17. Rajshahi Board-2023; Chattogram Board-2017; Sylhet Cadet College,
          Sylhet-2025
          <div className="border border-gray-500 p-1 rounded-sm my-2 ">
            victorious| Independence | champion| surrender | recapitulate |
            oppression | take | historical | birth| division | attack |
            significant
          </div>
          The most (a) __ event for Bangladesh is her (b) __ as an (c) __ nation
          on March 26, 1971. It is a red letter day in the (d) __ of Bangladesh.
          After the (e) __ of Sub-continent, we got Pakistan. But the Pakistanis
          ...
          স্বাধীন জাতি হিসেবে এর জন্মলাভ। বাংলাদেশের ইতিহাসে এটি একটি স্মরণীয়
          দিন। উপমহাদেশ বিভাজনের পর আমরা পেলাম পাকিস্তান। তবে পাকিস্তানিরা
          আমাদের জনসাধারণকে শোষণ করতে লাগল। প্রথমে তারা আমাদের ভাষাকেই আক্রমণ
          করলো। ১৯৫২ সালের ভাষা আন্দোলনের কথা আমরা কখনোই ভুলবো না। ভাষা আন্দোলন
        ...
        {/* 18 */}
        <div className="">
          18. Jashore Board-2023; Barishal Board-2017; Govt. Shah Sultan
          College, Bogura-2025
          <div className="border border-gray-500 p-1 rounded-sm my-2 ">
            all | follow | answer | use | through | necessary | rise | careful |
            begin distribute | have | carefully
          </div>
          Students should be strategic about their examination. It is (a) __ for
          an examinee to (b) __ some instructions. He should go (c) __ the whole
          question before he (d) __ to write. He must make (e) __ of his time so
          that he can (f) __ enough time to answer (g) __ questions. He must
          write his answer (h) __ . He should be (i) __ about his handwriting.
          He can (j) __ double spacing if his handwriting is tiny or very
          untidy. <br />
          <br />
          ছাত্র-ছাত্রীদের উচিত তাদের পরীক্ষার ব্যাপারে কৌশলী হওয়া। একজন,
          পরীক্ষার্থীর কতিপয় নির্দেশনা অনুসরণ করা প্রয়োজন। লেখা শুরু করার পূর্বে
          তার উচিত পুরো প্রশ্নটা পাঠ করা। তার উচিত সময়ের বণ্টন করা যাতে করে সে
          সকল প্রশ্নের উত্তর দেওয়ার জন্য যথেষ্ট সময় পায়। তার অবশ্যই সতর্কতার
        ...
        <div className="">
          ...
          Khulna-2025
          <div className="border border-gray-500 p-1 rounded-sm my-2 ">
            truthful | help | keep | characteristics | theory | cheat | need |
            easy | select | difficult | judge | suggestions
          </div>
          It is not easy to understand a man by seeing only his face. Even it is
          not easy to know about his mentality by (a) __ only his speeches. It
          is very difficult to examine a man's (b) __ by his outer appearances.
          So finding a friend is not very (c) __ . It is one of the world's most
          (d) __ tasks. Real friends are found in our (e) __ . A real friend is
          always (f) __ in his friend's dangers. He always (g) __ his friend's
          secrets secure. We can often be (h) __ by friends. We must remain
        ...
        {/* 20 */}
        <div className="">
          20. Chattogram Board-2023; Jhalokathi Government College,
          Jhalokathi-2025
          <div className="border border-gray-500 p-1 rounded-sm my-2 ">
            different | diseases | suffer | afflicted | fertilizers | rural |
            appear | severely | environment | substances | cause | alarm |
          </div>
          Many diseases are rising at an (a) __ rate which experts believe is
          due to increased pollution of the environment. Some specialists
          believe that pollution (b) __ to be greater in urban areas. Though (c)
          __ societies too are (d) __ by increased use of chemical (e) __ and
          insecticides, nevertheless, today city people appear to suffer from
          many more diseases and (f) __ more (g) __ than country people. Now let
        ...
        {/* 21 */}
        <div className="">
          21. Sylhet Board-2023; Cumilla Government College, Cumilla-2025
          <div className="border border-gray-500 p-1 rounded-sm my-2 ">
            from | hand | good | ask | is | towards | questions | even | no |
            change | part | depend
          </div>
          Hospitality has long been a (a) __ of our culture in Bangladesh.
          Although many other things are (b) __ Now, people are still quite
          polite and friendly (c) __ foreigners. They like speaking to
          foreigners (d) __ they have not been introduced to. It is quite common
          for Bangladesh is to (e) __ personal questions about family, jobs and
          income which visitors (f) __ - overseas might find awkward. However,
          it should be understood that (g) __ harm is meant by such (h) __ . On
          the other (i) __ they express a genuine interest in the foreigner's
          state of affairs. The whole country has a fairly (j) __ communication
          network now. <br />
          <br />
          আতিথেয়তা অনেক আগে থেকে আমাদের বাংলাদেশের সংস্কৃতির একটি অংশ। যদিও অনেক
          বিষয় পরিবর্তন হচ্ছে। এখনও মানুষ বিদেশীদের প্রতি ভদ্র ও বন্ধুভাবাপন্ন।
          এমনকি বিদেশিদের সাথে পরিচিত না হলেও তাদের সাথে কথা বলতে তারা পছন্দ
          করে। পরিবার, চাকরি ও উপার্জন সম্পর্কে ব্যক্তিগত প্রশ্ন করা বাংলাদেশে
          পুরোপুরি সাধারণ বিষয় যা বিদেশ থেকে আগত ভ্রমণকরীদের কাছে অদ্ভুত/বিশ্রী
        ...
        {/* 22 */}
        <div className="">
          22. Dinajpur Board-2023; Barishal Cadet College, Barishal-2025
          <div className="border border-gray-500 p-1 rounded-sm my-2 ">
            without | recent | river | face | last | native | clothes | farther
            | by | take | across | cause |
          </div>
          An old man sat (a) __ the side of the road beside a pontoon bridge (b)
          __ the river. The man had steel rimmed spectacles and was very dusty
          (c) __ . Carts, trucks, and men, women and children were crossing the
          (d) __ . The old man sat there (e) __ moving because he was too tired
          to go any (f) __ . The man came from San Carlos, his(g) __ town. The
        ...
        {/* 23 */}
        <div className="">
          23. Dhaka Board-2019: Safiuddin Sarker Academy & College, Tongi,
          Gazipur-2025
          <div className="border border-gray-500 p-1 rounded-sm my-2 ">
            result | dump | creature | odour | dispose | waterborne | avert |
            microphone | toxic avold | fume | determine
          </div>
          Every year millions of people all over the world die unnecessarily as
          a result of pollution. These unfortunate and (a) __ deaths are brought
          about by four specific factors. Firstly, air pollution from factories,
          burning trash, and vehicles (b) __ cause pneumonia, bronchitis and
          other respiratory diseases. Then, water pollution from industrial
          discharge, the indiscriminate (c) __ of toxic chemicals, and the (d)
          __ of human waste into rivers and canals causes poisoning and (e) __ -
          diseases such as cholera and diarrhoea. The next factor is the noise
          pollution from vehicle horns and (f) __ that might cause aggression
          and damage hearing. And finally, (g) __ pollution from dumped or
          untreated human waste causes serious discomfort to our sense of smell,
          and attracts disease-bearing (h) __ such as rats and flies. We take
        ...
        {/* 24 */}
        <div className="">
          24. Rajshahi Board-2019; Cantonment Public School & College,
          Rangpur-2025
          <div className="border border-gray-500 p-1 rounded-sm my-2 ">
            possible | waste | religion | allow | positive | circular |
            discourage | safe | tie | recruit | yet | though
          </div>
          To encourage female education, the government has taken some (a) __
          steps such as giving stipends to girl students, (b) __ more female
          teachers, etc. (c) __ girls cannot receive the full benefit of
          education mainly because of the following reasons. (d) __
          misinterpretation and social strictures (e) __ - girls from going to
          schools. Even in urban schools girls are not (f) __ by many parents to
        ...
        <div className="">
          ...
          Jhenidah-2025
          <div className="border border-gray-500 p-1 rounded-sm my-2 ">
            eloquent | choice | darkness | intellectual | awareness | purpose |
            learn | human | attain | sensibility | enlighten | parochialism
          </div>
          Education is the process by which our mind develops through formal (a)
          __ at an institution. It is mental and (b) __ training. It provides
          opportunities of growth and helps to (c) __ challenges. Moreover, the
          purpose of education is to (d) __ an individual. The aim of education
          is also to train individuals to make right (e) __ . It ennobles our
          mind and refines our (f) __ . It broadens our outlook and removes (g)
          __ It helps us to be (h) __ of our rights and responsibilities.
          Education furnishes us with an (i) __ in expressing truth. Therefore,
          it is compared to light which dispels the (j) __ of ignorance. <br />
          <br />
          শিক্ষা হচ্ছে সেই প্রক্রিয়া যে প্রক্রিয়ায় কোনো প্রাতিষ্ঠানিক শিক্ষার
          মাধ্যমে আমাদের মন বিকশিত হয়। এ হচ্ছে মানসিক ও বৃদ্ধিবৃত্তিক প্রশিক্ষণ।
          এটা বিকাশের সুযোগ করে দেয় এবং এটা সফলতা অর্জনের পথে বাধা-বিপত্তি
          মোকাবিলায় সাহায্য করে। তাছাড়া, শিক্ষার উদ্দেশ্য হচ্ছে কোনো ব্যক্তিকে
          আলোকিত করা। ব্যক্তিকে সঠিক সিদ্ধান্ত গ্রহণের প্রশিক্ষণ দেয়াও শিক্ষার
          লক্ষ্য। এটা আমাদের মনকে করে মহৎ আর অনুভূতিকে করে পরিশুদ্ধ। এটা আমাদের
          দৃষ্টিভঙ্গিকে করে প্রসারিত আর সংকীর্ণতা দূর করে। অধিকার ও দায়িত্ব
        ...
        {/* 26 */}
        <div className="">
          26. Cumilla Board-2019; Govt. Prafulla Chandra College, Bagerhat-2024
          <div className="border border-gray-500 p-1 rounded-sm my-2 ">
            communicate | be | different | convey | message | through | based |
            same | distribute | form | contrary | direct
          </div>
          Electronic mail or 'e-mail' is the communication of textual messages
          via electronic means. Another mode of electronic (a) __ is telex.
          Telex communication (b) __ terminal to terminal. 'E-mail' (c) __ from
          telex as it (d) __ messages user to user (e) __ using the computer.
          Destined (f) __ are sent to the (g) __ terminal where an operator (h)
          __ - it in a printed (i) __ in telex. On the (j) __ 'e-mail delivers
        ...
        {/* 27 */}
        <div className="">
          27. Chattogram Board-2019
          <div className="border border-gray-500 p-1 rounded-sm my-2 ">
            Extreme | Entire | Solid | Informed | Continue | Compete | Success |
            Earn | Perform | Study | Congratulate | Delight
          </div>
          Dear Mohua <br />
          Heartiest (a) __ on your grand (b) __ . I became (c) __ happy and (d)
          __ on being (e) __ that you won the 1st prize in the 4th Asian
          Painting Exhibition. To be the first in an international (f) __ is not
          the pride of the (g) __ only but of the (h) __ nation. By being so,
          you have (i) __ laurels for the country. I wish your (j) __ - success
          in this field. Keep on trying. Have a nice day. <br />
          Yours ever. <br />
          Nabin <br />
          <br />
          প্রিয় মতুয়া, <br />
          বিশাল সাফল্যের জন্য তোমাকে আন্তরিক অভিনন্দন। তুমি চতুর্থ এশীয় চিত্রকলা
          প্রদর্শনীতে প্রথম হয়েছো, এটা জেনে আমি অত্যন্ত সুখি ও আনন্দিত। একটি
          আন্তর্জাতিক প্রতিযোগিতায় প্রথম হওয়ার বিষয়টি শুধু অংশগ্রহণকারীর জনোই
          গর্বের নয়, এটা পুরো জাতির জন্যেও গর্বের বিষয়। এই বিজয়ী হওয়াতে তুমি
          দেশের জন্য সম্মান বয়ে এনেছ। এক্ষেত্রে আমি তোমার ধারাবাহিক সফলতা কামনা
          করি। চেষ্টা করতে থাকো। দিনটি শুভ হোক। <br />
          তোমার বন্ধু, <br />
          নবিন
          <br />
        </div>
        ...
        <div className="">
          ...
          <div className="border border-gray-500 p-1 rounded-sm my-2 ">
            ...
            Migratory | Birds | Local | System | Provides
          </div>
          Hakaluki Haor has both economic and non-economie (a) __ . It (b) __ -
          a wide range of (c) __ to the local people. People (d) __ here can
          produce fish and rice, rear (e) __ , buffalo and duck. They can also
          (f) __ reeds (g) __ grass in the haor. This haor (h) __ also provides
          (i) __ place for the (j) __ birds. <br />
          <br />
          হাকালুকি হাওড়ের অর্থনৈতিক এবং অর্থনৈতিক নয়- এই উভয় গুরুত্বই রয়েছে। এটা
          স্থানীয় লোকদেরকে ব্যাপক সুবিধা দিয়ে থাকে। এখানে বসবাসকারী লোকজন মাছ
        ...
        {/* 29 */}
        <div className="">
          29. Jashore Board-2005; Sylhet Board-2012; Barishal Board-2019
          <div className="border border-gray-500 p-1 rounded-sm my-2 ">
            Read | Used | Up | s See | Dots | Print | Although | Touch | Develop
            | Bear | Way | Call
          </div>
          (a) __ blind people cannot (b) __ , their sense of (c) __ becomes far
          more (d) __ - than that of most sighted people. This ability was put
          to use by a brilliant man (e) __ Louis Braille. In the early 19th
          century, he invented a (f) __ of writing which (g) his name. The
          Braille system reproduces the letters of the alphabet by a series in
          certain positions, which are raised on the paper. The blind person
          runs the (h) __ of his fingers across the pages of the Braille book
          and can work out the letters and numbers (i) __ there. of (j) __{" "}
          <br />
          <br />
          অন্য লোকজন পড়তে না পারলেও তাদের স্পর্শানুভূতি খুব দৃষ্টিশক্তি সম্পন্ন
          ব্যক্তির চেয়েও অনেক বেশি উন্নত। এই সক্ষমতা লুইস ব্রেইলী নামে একজন
          প্রতিভাধর ব্যক্তির মাধ্যমে প্রবর্তিত হয়েছিল। উনিশ শতকের প্রথম ভাগে
          তিনি তার নামে একটি লিখন পদ্ধতি আবিষ্কার করেন। ব্রেইলী পদ্ধতি কাগজের
          উপর স্থাপিত নির্দিষ্ট অবস্থানে একগুচ্ছ বিন্দুর মাধ্যমে বর্ণমালা তৈরি
          করে। অন্য ব্যক্তি ব্রেইলী বইয়ের পৃষ্ঠায় আঙ্গুলের ডগা দিয়ে ছাপানো অক্ষর
          ও সংখ্যা দিয়ে কাজ করতে পারে। <br />
          <br />
          <br />
        </div>
        {/* 30 */}
        <div className="">
          ...
          Man's dignity depends upon his works. Man is a (a) __ being on earth.
          He is to (b) __ for others. He should not be (e) __ if he is of (d) __
          He should be (e) __ blood. to help any (1) __ of man. The man whom he
          is helping may be (g) __ to him by (h) __ the (1) __ blood and flesh
          as the above (1) __ man. But after all, he is a man. He has <br />
          <br />
          মানুষের মর্যাদা নির্ভর করে তার কাজের উপর। পৃথিবীতে মানুষ একটি
          বিচারবুদ্ধিসম্পন্ন প্রাণী। তাকে অন্যদের জন্য কাজ করতে হয়। সে অভিজাত
          শ্রেণীর হলেও তার গর্বিত হওয়া উচিত নয়। তাকে যে কোন শ্রেণীর মানুষকে
          সাহায্য করার জন্য তৈরি থাকতে হবে। যাকে সে সাহায্য করছে সে জন্মগত দিক
          থেকে তার চেয়ে নিচু শ্রেণীর হতে পারে। কিন্তু মোটের উপর সে একজন মানুষ।
