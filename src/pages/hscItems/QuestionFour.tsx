    ...
    <div className="px-3 lg:w-1/2 mx-auto">
      ...
      <div className="text-base lg:text-xl">
        ...
        <div className="">
          ...
          <br />
          <br />
          বঙ্গানুবাদ: অন্য লোকজন পড়তে না পারলেও তাদের স্পর্শানুভূতি খুব
          দৃষ্টিশক্তি সম্পন্ন ব্যক্তির চেয়েও অনেক বেশি উন্নত। এই সক্ষমতা লুইস
          ব্রেইলী নামে একজন প্রতিভাধর ব্যক্তির মাধ্যমে প্রবর্তিত হয়েছিল। উনিশ
          শতকের প্রথম ভাগে তিনি তার নামে একটি লিখন পদ্ধতি আবিষ্কার করেন। ব্রেইলী
