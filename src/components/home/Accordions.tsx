            ...
            <div className="dark:text-gray-400">
              ...
              <div className="">
                ...
                <div className="border p-2 rounded-sm">
                  ...
                  হা-বোধক বাক্যের Subject যদি 3rd person + singular হয় তবে verb
                  এর সাথে s/ es যুক্ত হয় <br />
                  যেমনঃ <br />
                  সে ভাত খায় - He eats rice. <br />
                  <strong>👉 (২)</strong> Verb এর শেষে যদি = s, sh, ch, x, o, y,
                  z থাকে তবে Verb এর শেষে = es যুক্ত হয়। <br />
                  যেমনঃ He goes (go = goes) <br />
                  ...
                  যেমনঃ He plays (play = plays).
                  <br />
                  <strong>Y ব্যতিক্রম: </strong> Y এর পরে es যুক্ত করার ক্ষেত্রে
                  y স্থানে i হয় তার পরে es হয়। যেমনঃ He cries (cry = cries).{" "}
                </div>
                <br />
          ...
          <AccordionContent>
            <div className="mb-2 dark:text-gray-400">
              <div className="">
                ...
                for ten minutes. <br />
                সে সকাল থেকে বল খেলতেছে - He has been playing football since
                morning.
                <br />
                <br />
            ...
            <div className="mb-2 dark:text-gray-400">
              <div className="">
                ...
                <div className="pt-10">
                  ...
                  <p className="">
                     বাংলা ক্রিয়ার শেষে যদি তে, ত, তাম ইত্যাদি থাকে তবে
                    বাক্যের গঠন হবে নিম্নরূপঃ <br />
          ...
          <AccordionContent>
            <div className="mb-2 dark:text-gray-400">
              <div className="">
                ...
                <br />
                চিনার উপায়ঃ <br /> বাংলা ক্রিয়ার শেষে - তেছিল/চ্ছিল, তেছিলে/চ্ছিলে,
                ...
                * Was/Were + Sub + V<sub>1</sub> এর সাথে ing + obj + others.
                ...
                <br />
                যেমনঃ <br />
                আমরা কি ভাত খাচ্ছিলাম না? - Weren't we eating rice /
          ...
          <AccordionContent>
            <div className="mb-2 dark:text-gray-400">
              <div className="">
                ...
                <br />
                <br />
                <strong>NOTE: <br /> (1) </strong>বাক্যের Subject অনুসারে সাহায্যকারি
                verb হবে। যেমনঃ <br />
                ১। 1st person subject এর সাথে = shall হয়, <br />
                ২। অন্যান্য সকল sub এর সাথে = will হয়। <br />
                <strong>NOTE:  <br /> (2) </strong> American English এ সকল Subject এর সাথে
                will ব্যবহার হয়। 
                <br />
                <br />
                না-বোধক বাক্যের <strong>গঠন</strong>: <br />
