          ...
          <AccordionContent>
            <div className="mb-2 dark:text-gray-400">
              <div className="">
                ...
                <br />
                যেমনঃ খাইলাম/খেলাম/খাইয়াছিলাম <br /><br />
                <strong>গঠন</strong> (<strong>Structure</strong>): <br />  
                হা-বোধক বাক্যের <strong>গঠন</strong>: <br />
                <strong> 
                ...
                * Hadn't + Sub+ V3 + obj + others?
                ...
                <br /><strong>গঠন(Structure)</strong>:
                <br />
                ...
                eaten rice. <br />
                <br />
                <span className="animateText">Short Technique:</span>  <br />
                before এ before এবং after এ after হয়: <br /> 
                অর্থাৎ বাক্যের মধ্যে ব থাকলে প্পপ্প এর বাক্যটি আ/ আগেই হবে।
              </div>
            </div>
          </AccordionContent>
        </AccordionPanel>
