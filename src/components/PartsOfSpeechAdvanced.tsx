    ...
    <div className="h-full lg:w-[60%] mx-auto px-3">
      ...
      <div className="h-full">
        ...
        <div className="">
          ...
          ইন্দ্রিয়ের আওতাভুক্ত। ভাবগত বা ধারণাগত বলতে বুঝায় আমাদের
          পঞ্চইন্দ্রিয়ের আওতার বাইরে। যেমন, সততা, কৈশোর, সৌন্দর্য, পাপ, পুণ্য,
          মেধা, এগুলো আমাদের পঞ্চইন্দ্রিয়ের আওতাভুক্ত নয়। <br />
          ঐতিহ্যিক (traditional) ইংরেজি Grammar পাঁচ ভাগে ভাগ করেছে noun-কে:{" "}
          <br />
          (1) Proper noun (ব্যক্তি, জীব, জায়গা, বা ঘটনার নাম) <br />
          যেমন, Selim (একজন মানুষের নাম), Tom (কোন একটা কুকুরের নাম) Dhaka
          (জায়গার নাম), Romantic Movement (ঘটনার নাম)রাজী
          <br />
          <br />
          (2) Common noun (এক জাতীয় প্রাণী বা বস্তুর নাম) যেমন man (যে কোন
          মানুষ, কিন্তু কোন মানুষের নাম হলে সেটা Proper noun হবে, যেমন Selim),
          dog (যে কোন কুকুর কিন্তু কোন কুকুরের নাম Tom হলে সেটা তখন Proper noun
          হবে), water (যে কোন স্থানের পানি, কিন্তু কোন বিশেষ পানি বুঝালে Proper
          noun হবে, যেমন- Padma)
          <br />
          <br />
          ...
          Material noun বলতে যে পদার্থ দ্বারা কোন বস্তু তৈরি হয়, যেমন gold একটা
          material noun, কিন্তু সোনার তৈরি necklace হচ্ছে common noun. তেমন
          water একটা material noun, কিন্তু padma হচ্ছে proper noun) <br />
          ...
          <br />
          যেমন, honesty, education, policy, meditation, beauty, ugliness,
          ইত্যাদি। এ জাতীয় কোন কিছু ইন্দ্রিয়গ্রাহ্য নয়।
          <br />
          <br />
          ...
          গণনাযোগ্য, এবং uncountable-এর অর্থ অগণ্য। countable nouns-কে count
          nouns এবং uncountable nouns-কে noncount nouns বা mass nouns-ও বলা হয়।
          Count nouns-গুলোর একবচন বা বহুবচন দুটোই হতে পারে। Noncount nouns-এর
          শুধু একবচন হতে পারে। অর্থাৎ বাক্যে ব্যবহৃত হ'লে যখন একবচন (singular)
          হিসেবে ব্যবহৃত হয় তখন verb-ও একবচন হয়, এবং বহুবচন (plural) হিসেবে
          ব্যবহৃত হ'লে verb ও plural হয়। তবে ব্যাপারটা এমন নয় যে countable এবং
          uncountable nouns-এর মধ্যে জলরোধক (watertight) কোন ব্যবধান আছে। অর্থাৎ
          কোন কোন nouns এক অর্থে countable হতে পারে, এবং অন্য অর্থে uncountable
          হতে পারে। তবে কোন কোন noun আছে যা কখনও singular হিসেবে ব্যবহৃত হয় না।
          আবার কোন কোন noun আছে যা কখনও plural হিসেবে ব্যবহৃত হয় না। কোন কোন
          noun আছে যা দেখতে plural <br />
          অর্থাৎ form হচ্ছে plural, কিন্তু ব্যবহৃত হয় singular হিসেবে। ইত্যাদি
          বিচিত্র ধরনের noun হতে পারে। যেমন: <br />
          Uncountable (singular) অর্থ - Countable অর্থ (plural) <br />
          Water - পানি Waters - বিভিন্ন জলাশয় <br />
          Sand - বালু - Sands - বালুময় স্থানসমূহ <br />
          Iron - লোহা - Irons ইস্ত্রীসমূহ <br />
          Character চরিত্র Characters নাটক বা সিনেমায় অভিনয়কারী ব্যক্তি <br />
          ...
          noun-গুলোর কখন ও plural form ব্যবহৃত হয় না, অর্থাৎ সব সময়ই
          uncountable. <br />
          ...
          plural-men <br />
          2. বাক্যে এর সংগে singular বা plural verb ব্যবহৃত হয়, এটা নিজে
          singular বা plural কিনা সেই অনুসারে। যেমন: The boy is playing. The
          boys are playing. <br />
          ...
          <br />
          4. এটা plural হলে তার আগে many বা few ইত্যাদি ব্যবহৃত হতে পারে। যেমন:
          1. He has many books. 2. He has few books. <br />
          3. এর আগে a, an, বা one ব্যবহৃত হয় না। যেমন: He has a kindness হয় না।{" "}
          <br />
          4. এর আগে much বা little ইত্যাদি পরিমান বাচক modifier ব্যবহৃত হতে
          পারে। যেমন: 1. He has much wealth. 2. She has little wealth <br />
          5 <br />
          ...
          number of books. <br />
          6. এর আগে amount of ব্যবহৃত হতে পারে। যেমন: She has an amount of
          bread. <br />
