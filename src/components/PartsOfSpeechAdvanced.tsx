  ...
  return (
    <div className="h-full lg:w-[60%] mx-auto ">
      ...
      <div className="h-full">
        ...
        ছাত্র-ছাত্রীদের জন্য এগুলোর বিস্তারিত জ্ঞান ইংরেজি শেখার জন্য প্রয়োজন হয়
        না। বরং Parts of speech সম্বন্ধে বিস্তারিত জ্ঞান ইংরেজি ভাষা শেখার
        ...
        কতটুকু শিখলে ছাত্রদের জন্য যথেষ্ট তার ইংগিত দেয়া হবে। <br />
        * ইংরেজিতে Parts of speech নিম্নোক্ত প্রকার : <br />
        ...
        কিছুকে noun বলে। <br />
        ইন্দ্রিয়গ্রাহ্য বলতে বুঝায় মানুষের পঞ্চইন্দ্রিয়ের আওতাভুক্ত। যেমন, ইট,
        পাথর, কাঠ, শব্দ, স্বাদ, গন্ধ, বাতাস এগুলোর এক একটা আমাদের কোন না কোন
        ইন্দ্রিয়ের আওতাভুক্ত। ভাবগত বা ধারণাগত বলতে বুঝায় আমাদের পঞ্চইন্দ্রিয়ের
        আওতার বাইরে। যেমন, সততা, কৈশোর, সৌন্দর্য, পাপ, পুণ্য, মেধা, এগুলো আমাদের
        পঞ্চইন্দ্রিয়ের আওতাভুক্ত নয়। <br />
        ঐতিহ্যিক (traditional) ইংরেজি Grammar পাঁচ ভাগে ভাগ করেছে noun-কে:{" "}
        <br />
        (1) Proper noun (ব্যক্তি, জীব, জায়গা, বা ঘটনার নাম) <br />
        যেমন, Selim (একজন মানুষের নাম), Tom (কোন একটা কুকুরের নাম) Dhaka (জায়গার
        নাম), Romantic Movement (ঘটনার নাম)রাজী <br /> । 30 <br />
        (2) Common noun (এক জাতীয় প্রাণী বা বস্তুর নাম) যেমন man (যে কোন মানুষ,
        কিন্তু কোন মানুষের নাম হলে সেটা Proper noun হবে, যেমন Selim), dog (যে
        কোন কুকুর কিন্তু কোন কুকুরের নাম Tom হলে সেটা তখন Proper noun হবে),
        water (যে কোন স্থানের পানি, কিন্তু কোন বিশেষ পানি বুঝালে Proper noun
        হবে, যেমন Padma) <br />
        (3) Collective noun (একজাতীয় প্রাণী বা বস্তুর গ্রুপ বুঝায়) <br />
        যেমন, army, (সৈন্যদের একত্রিত অবস্থান), <br />
        Crowd (মানুষের একত্রিত অবস্থান) Flock of sheep (ভেড়ার একত্রিত অবস্থান)।{" "}
        <br />
        ...
        (4) Material noun (matters বা বস্তু থেকে এটার নামকরণ করা হয়েছে) Material
        noun বলতে যে পদার্থ দ্বারা কোন বস্তু তৈরি হয়, যেমন gold একটা material
        noun, কিন্তু সোনার তৈরি necklace হচ্ছে common noun. তেমন water একটা
        material noun, কিন্তু padma হচ্ছে proper noun) <br />
        উপরোক্ত ৪ প্রকার noun হচ্ছে concrete noun-এর আওতাভুক্ত, ইন্দ্রিয়গ্রাহ্য।
        আর: <br />
        (5) Abstract Noun হচ্ছে ধারণাগত বা ভাবগত, যাকে নির্বস্তুক বলা যায়। যেমন,
        honesty, education, policy, meditation, beauty, ugliness, ইত্যাদি। এ
        জাতীয় কোন কিছু ইন্দ্রিয়গ্রাহ্য নয়। <br />
        Parts of Speech-এর Number <br />
        Noun একবচন বা বহুবচন হতে পারে কি পারে না সেই দৃষ্টিকোণ থেকে তাকে
        countable এবং uncountable এই দুইভাগে ভাগ করা হয়। Countable-এর অর্থ
        গণনাযোগ্য, এবং uncountable-এর অর্থ অগণ্য। countable nouns-কে count nouns
        এবং uncountable nouns-কে noncount nouns বা mass nouns-ও বলা হয়। Count
        nouns-গুলোর একবচন বা বহুবচন দুটোই হতে পারে। Noncount nouns-এর শুধু একবচন
        হতে পারে। অর্থাৎ বাক্যে ব্যবহৃত হ'লে যখন একবচন (singular) হিসেবে ব্যবহৃত
        হয় তখন verb-ও একবচন হয়, এবং বহুবচন (plural) হিসেবে ব্যবহৃত হ'লে verb ও
        plural হয়। তবে ব্যাপারটা এমন নয় যে countable এবং uncountable nouns-এর
        মধ্যে জলরোধক (watertight) কোন ব্যবধান আছে। অর্থাৎ কোন কোন nouns এক অর্থে
        countable হতে পারে, এবং অন্য অর্থে uncountable হতে পারে। তবে কোন কোন
        noun আছে যা কখনও singular হিসেবে ব্যবহৃত হয় না। আবার কোন কোন noun আছে যা
        কখনও plural হিসেবে ব্যবহৃত হয় না। কোন কোন noun আছে যা দেখতে plural{" "}
        <br />
        Parts of Speech: A Quick Glance 31 <br />
        অর্থাৎ form হচ্ছে plural, কিন্তু ব্যবহৃত হয় singular হিসেবে। ইত্যাদি
        বিচিত্র ধরনের noun হতে পারে। যেমন: <br />
        Uncountable (singular) অর্থ <br />
        Countable অর্থ (plural) <br />
        Water পানি <br />
        Waters বিভিন্ন জলাশয় <br />
        Sand বালু <br />
        Sands বালুময় স্থানসমূহ <br />
        Iron লোহা <br />
        Irons ইস্ত্রীসমূহ <br />
        Character চরিত্র <br />
        Characters নাটক বা সিনেমায় অভিনয়কারী ব্যক্তি <br />
        উপরোক্ত noun-গুলো uncountable অর্থাৎ singular form-এ ব্যবহৃত হলে এক
        অর্থ, এবং plural form-এ বা countable form-এ ব্যবহৃত হলে অন্য অর্থ হয়।{" "}
        <br />
        আবার: <br />
        Honesty, cooperation, education, information, kindness ইত্যাদি
        noun-গুলোর কখন ও plural form ব্যবহৃত হয় না, অর্থাৎ সব সময়ই uncountable.{" "}
        <br />
        ...
        molasses ইত্যাদি <br />
        বিপরীত ভাবে, নিম্নোক্ত noun-গুলোর form হচ্ছে plural, এবং সবসময় plural
        হিসেবেই ব্যবহৃত হয়, কখনও singular হিসেবে নয়: <br />
        Riches (সম্পদ অর্থে); remains (অবশিষ্টাং অর্থে); manners (ভাল ব্যবহার
        অর্থে); thanks (ধন্যবাদ অর্থে); particulars (খুঁটিনাটি বর্ণনা অর্থে),
        ইত্যাদি। <br />
        Countable এবং uncountable noun-এর প্রকৃতিগত পার্থক্য: <br />
        Countable Nouns <br />
        1. Singular এবং plural উভয় Form-ই হতে পারে। যেমন singular-man এবং
        plural-men <br />
        2. বাক্যে এর সংগে singular বা plural verb ব্যবহৃত হয়, এটা নিজে singular
        বা plural কিনা সেই অনুসারে। যেমন: The boy is playing. The boys are
        playing. <br />
        Uncountable Nouns <br />
        1 . শুধু singular form হতে পারে। <br />
        যেমন: education. <br />
        2. এর সংগে শুধু singular verb ব্যবহৃত হয়। যেমন : Education is important
        for every man. <br />
        32 FRIENDS' Language <br />
        3. এটা singular হলে এর আগে ৫, an, অথবা one ব্যবহৃত হতে পারে। যেমন: 1. It
        is a book 2. It is an egg. 3. There is one book on the table. <br />
        4. এটা plural হলে তার আগে many বা few ইত্যাদি ব্যবহৃত হতে পারে। যেমন: 1.
        He has many books. 2. He has few books. <br />
        3. এর আগে a, an, বা one ব্যবহৃত হয় না। যেমন: He has a kindness হয় না।{" "}
        <br />
        4. এর আগে much বা little ইত্যাদি পরিমান বাচক modifier ব্যবহৃত হতে পারে।
        যেমন: 1. He has much wealth. 2. She has little wealth <br />
        5 <br />
        . এটা plural হলে এর আগে some ব্যবহৃত হতে পারে। যেমন: 1. She has some
        ornaments. <br />
        5. The child has some chocolate. <br />
        6. এটা plural হলে এর আগে a number of ব্যবহৃত হতে পারে। যেমন: He has a
        number of books. <br />
        6. এর আগে amount of ব্যবহৃত হতে পারে। যেমন: She has an amount of bread.{" "}
        <br />
        সাধারণত: countable হিসেবে ব্যবহৃত হয় এমন কিছু noun নিচে উল্লেখ করা হলো:{" "}
        <br />
        ...
        5. কোন কিছুর অংশ: an ankle, a bone, a nose, a wing, ইত্যাদি। <br />
        6. নির্দিষ্ট আকৃতি আছে এমন কিছু: a building, a door, a mountain, an
        umbrella ইত্যাদি। <br />
        7. পরিমাপের ইউনিট: a foot, a meter, a piece, a gram, a pound ইত্যাদি।{" "}
        <br />
        ৪. শ্রেণী বিন্যাস: a family, a city, a word, a phrase ইত্যাদি। <br />
        9. কিছু abstract (নির্বস্তুক) শব্দ: a hindrance, a nuisance, a plan, a
        taboo ইত্যাদি। <br />
        সাধারণত: Uncountable হিসেবে ব্যবহৃত এমন কিছু noun নীচে উল্লেখ করা হলো:{" "}
        <br />
        1. খাদ্য জাতীয় জিনিসের নাম: <br />
        Bread, cake, chocolate, spinach, spaghetti, butter, cheese, ইত্যাদি।{" "}
        <br />
        2 <br />
        Parts of Speech: A Quick Glance 33 <br />
        2. বস্তু এবং ধাতু: <br />
        ...
        অধিকাংশ noun-এর শেষে ১ যোগ করলে plural হয়। তবে pluralisation-এর ব্যাপারে
        ...
        2. শেষে-f, বা-fe থাকলে plural-এ-ves হয়, কোন কোন noun-এর ক্ষেত্রে: <br />
        Singular <br />
        ...
        Possessive বলতে noun বা pronoun-এর একটা form যেটা কোন noun বা pronoun-এর
        কিছু আছে, বা কোন কিছু তার দখলে আছে এরূপ বুঝায়। আমরা এখানে noun-এর
        possessive form আলোচনা করছি। Possessive দুভাবে গঠন করা যায়: <br />
        ...
        Cow's milk (গরুর দুধ); America's foreign policy (আমেরিকার বৈদেশিক নীতি);
        goat's cheese (ছাগদুগ্ধের পনির)। <br />
        ...
        (4) কিছু কিছু English idiom-এর ক্ষেত্রে an arm's length; for economy's
        sake; our money's worth. <br />
        (5) যে সমস্ত plural-এর শেষে "n" থাকে: children's education; men's wear,
        women's rights. <br />
        (6) 's-possessive দ্বারা বিশেষিত কোন noun উহ্য থাকতে পারে যদি প্রসঙ্গ
        থেকে তা বোঝা যায়: <br />
        ...
        memory-এর উল্লেখ নিষ্প্রয়োজন, কারণ তা context থেকেই বোঝা যাচ্ছে। <br />
        Note যে সমস্ত নাম মানুষ, জীবজন্তু, বা দেশের নাম নয় সেগুলোর 's possessive
        না ব্যবহার করাই উত্তম, এবং "of" possessive দ্বারা প্রকাশ করাই উচিত:{" "}
        <br />
        The name of the street. (The street's name নয়) <br />
        The back of the room. (The room's back নয়) <br />
        Lore <br />
        (7) কখনও কখনও দুই বা ততোধিক ব্যক্তি কোন প্রতিষ্ঠান বা সম্পদের মালিক হয়।
        সে ক্ষেত্রে শেষোক্ত নামের পরে 's বসে: <br />
        ...
        camelD メッ <br />
        FRIENDS' Language <br />
        (2) যে সমস্ত নামের শেষে ৪ থাকে; <br />
        ...
        Possession-এর নামটা আগে বসিয়ে তার পর "of” এবং possessor-এর নাম বসাতে হয়।
        তখন 's দরকার হয় না। <br />
        যেমন: Keats's poetry এটা the poetry of Keats এভাবেও লেখা যায়। কোন কোন
        ক্ষেত্রে, বিশেষ করে জড় পদার্থের ক্ষেত্রে of-possessive ব্যবহার অধিকতর
        কাম্য। <br />
        যেমন: <br />
        ...
        তবে কতকগুলো ক্ষেত্রে 's possessive লেখাই যায় না। যেমন: the hub of the
        wheel-এর পরিবর্তে the wheel's hub, লেখা যাবে না। <br />
        ...
        বিস্তৃত বিষয় শেখানোর চেষ্টা করেন যদিও ভালো উদ্দেশ্য নিয়ে, কিন্তু তার
        ফলাফল হয় খারাপ। অর্থাৎ তাঁদের এই প্রচেষ্টা ছাত্রদের মধ্যে demotivation
        (নিরুদ্যম) সৃষ্টি করে। noun পাঁচ প্রকার, pronoun অতো প্রকার, adjective
        ততো প্রকার ইত্যাদি মনে রাখার জন্য ছাত্রদের ওপর চাপ সৃষ্টি করলে তাদের
        মধ্যে ভাষা শেখার প্রতি একটা বিতৃষ্ণা জন্মায়, এবং এর ফলে তারা শেখার
        প্রচেষ্টাকে শিথিল করে ফেলে, অথবা ইচ্ছাটাকে একেবারে ঝেড়ে ফেলে দিয়ে
        ভবিতব্যের ওপর নিজকে সম্পূর্ণভাবে সমর্পিত করে loin tasd (shequo) bnet){" "}
        <br />
        ইংরেজি ভাষা শেখার জন্য noun সম্বন্ধে যেটুকু মনে রাখলেই যথেষ্ট তা হচ্ছে:{" "}
        <br />
        ...
        (a) book, (b) artist, (c) honesty, (d) beauty, (e) school, (f) college,
        (g) education, (h) air, (i) administration, (j) gold, (k) manhood, (1)
        parent, (m) help, (n) friendship, (o) truth, (p) <br />
        sunshine. <br />
        Exercise-2 <br />
        Change the concrete nouns into abstract nouns, and vice versa: <br />
